...
public class AnimalProcessor {
    ...
    // Nie oznacza to, że wywołujemy metodę z klasy abstrakcyjnej.
    // Na podstawie klasy abstrakcyjnej nie możemy utworzyć obiektu. Poniższy zapis mówi, że dana metoda ma zostać wywołana z każdego obiektu, który jest podtypem Animal.
