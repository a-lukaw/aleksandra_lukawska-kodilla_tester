...
public class Student {
    ...
    //tworzymy obiekty typu Grades
    //obiekty prywatne == oceny widoczne są tylko w klasie Student
    private String name;
    ...
    public double getMathsAverage() {
        return this.maths.getAverage(); }                                           //wywołanie metody z klasy Grades obliczającej średnią ocen
    ...
    public double getAverage() {                                                                                                    //zwrócenie średniej ocen ze wszystkich przedmiotów
